...
\input{architecture/3_0_dataset_extraction}
\input{architecture/3_1_vocab_induction}
\input{architecture/3_2_seed_embeddings}
\input{architecture/3_3_span_predictor}
\input{architecture/3_4_length_estimator}
\input{architecture/3_5_modality_typing}
\input{architecture/3_6_span_embedding}
\input{architecture/3_7_controller_fusion}
\input{architecture/3_8_span_interpolation}
\input{architecture/3_9_runtime_complexity}